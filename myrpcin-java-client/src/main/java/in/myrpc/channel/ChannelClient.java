...
public abstract class ChannelClient {
    ...
    public abstract void open() throws ChannelException, JSONException;
    ...
    private static class ProdChannelClient extends ChannelClient {
        ...
        @Override
        public void open() throws ChannelException, JSONException {
            initialize();
            fetchSid();
            connect();
            longPoll();
        ...
        private void initialize() throws ChannelException, JSONException {
            ...
            System.out.println("Initializing: " + initUri);
            ...
            System.out.println("Initialization complete, [CLID=" + mClid + "] [SessionID=" + mSessionID + "]");
        }
        ...
        private void fetchSid() throws ChannelException {
            System.out.println("Fetching SID");
                    ...
                    while (mIsRunning) {
                        if (parser == null) {
                            ...
                            if (parser == null) {
                                ...
                                System.out.println("Could not connect to channel endpoint, trying again.");
                                try {
                                    Thread.sleep(2500);
               ...
               public void run() {
                   while(mIsRunning) {
                       ...
                       try {
                           ...
                           System.out.println("Erroring polling for updates from channel, giving up...");
                           return;
                       }
                   }
               }
